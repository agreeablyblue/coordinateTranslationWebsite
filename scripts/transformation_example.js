...
var transformationContainer = document.getElementById('transformationContainer');
...
var arrowHelper6 = new THREE.ArrowHelper(dir1, origin, length, hex, headLength, headWidth);
var arrowHelper7 = new THREE.ArrowHelper(dir2, origin, length, hex, headLength, headWidth);
...
group2.add(arrowHelper7);

arrowHelper5.position.z = -270;
arrowHelper5.position.x = 152;

arrowHelper6.position.z = -270;
arrowHelper6.position.x = 155;
arrowHelper6.rotation.y = THREE.Math.degToRad(45);

arrowHelper7.position.z = -270;
arrowHelper7.position.x = 155;
arrowHelper7.rotation.z = THREE.Math.degToRad(45);
...
circle2.position.z = -68;
circle2.position.x = -45;
circle3.position.z = -68;
circle3.position.x = 267;
